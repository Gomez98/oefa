...
export class HttpService {
  ...
  private loginStatusMessage = new BehaviorSubject(false);
  currentLoginStatusMessage = this.loginStatusMessage.asObservable();

  constructor(
    private http: HttpClient
  ) { }

  updateLoginStatus(message: boolean) {
    this.loginStatusMessage.next(message)
  }
